    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDoSomethingCoolButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                // TODO (1) Retrieve the text from the EditText and store it in a variable Okay
                ...
                // TODO (2) Use the putExtra method to put the String from the EditText in the Intent Okay
