    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDoSomethingCoolButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // TODO (1) Store ChildActivity.class in a Class object called destinationActivity Okay
                Class<ChildActivity> destinationActivity = ChildActivity.class;
                // TODO (2) Create an Intent to start ChildActivity Okay
                Intent goChildActivity = new Intent(context, destinationActivity);
                // TODO (3) Replace the Toast with code to start ChildActivity Okay
                startActivity(goChildActivity);
            }
        });
    }
}
