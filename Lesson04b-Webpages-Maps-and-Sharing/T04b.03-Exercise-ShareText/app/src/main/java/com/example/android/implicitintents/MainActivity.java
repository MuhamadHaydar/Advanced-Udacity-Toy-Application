...
public class MainActivity extends AppCompatActivity {
    ...
    public void onClickShareTextButton(View v) {
        // TODO (5) Specify a String you'd like to share Okay

        String contentText = "Meno player is an android application to store player result.";

        // TODO (6) Replace the Toast with shareText, passing in the String from step 5 Okay
    ...
    // TODO (1) Create a void method called shareText that accepts a String as a parameter Okay
    // Do steps 2 - 4 within the shareText method

    // TODO (2) Create a String variable called mimeType and set it to "text/plain" Okay

    // TODO (3) Create a title for the chooser window that will pop up Okay

    // TODO (4) Use ShareCompat.IntentBuilder to build the Intent and start the chooser Okay

    private void shareText(String shareContent) {
        String mimeType = "text/plain";
        String title = "Choose application";
        ShareCompat.IntentBuilder.from(this).setChooserTitle(title).setType(mimeType).setText(shareContent).startChooser();
    }
}