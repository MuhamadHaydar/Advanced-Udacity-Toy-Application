...
public class VisualizerActivity extends AppCompatActivity implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    // TODO (4) Update the code in setupSharedPreferences and onSharedPreferenceChanged to update Okay
    ...
    private void setupSharedPreferences() {
        ...
        mVisualizerView.setShowMid(sharedPreferences.getBoolean(getString(R.string.pref_show_mid_square_key),
                getResources().getBoolean(R.bool.pref_show_mid_square_default)));
    ...
    public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
        if (key.equals(getString(R.string.pref_show_bass_key))) {
            ...
            mVisualizerView.setShowMid(sharedPreferences.getBoolean(getString(R.string.pref_show_mid_square_key), getResources().getBoolean(R.bool.pref_show_mid_square_default)));
        }
    }
