...
public class VisualizerActivity extends AppCompatActivity implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    // TODO (4) Update setupSharedPreferences and onSharedPreferenceChanged to load the color Okay
    // from shared preferences. Call setColor, passing in the color you got

    void loadPreferenceColor(SharedPreferences sharedPreferences) {
        mVisualizerView.setColor(sharedPreferences.getString(getString(R.string.pref_shape_color_key), getString(R.string.perf_shape_color_default)));
    }
    ...
    private void setupSharedPreferences() {
        ...
        // Method is used to load color from.
        loadPreferenceColor(sharedPreferences);
