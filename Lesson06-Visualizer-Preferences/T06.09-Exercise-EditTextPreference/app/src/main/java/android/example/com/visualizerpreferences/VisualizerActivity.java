...
public class VisualizerActivity extends AppCompatActivity implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    // TODO (2) Modify the setupSharedPreferences method and onSharedPreferencesChanged method to Okay
    ...
    private void loadSizeFromPreferences(SharedPreferences sharedPreferences) {
        String loadedSize = sharedPreferences.getString(getString(R.string.pref_shape_size_key), getString(R.string.pref_shape_size_default));
        float size = Float.parseFloat(loadedSize);
