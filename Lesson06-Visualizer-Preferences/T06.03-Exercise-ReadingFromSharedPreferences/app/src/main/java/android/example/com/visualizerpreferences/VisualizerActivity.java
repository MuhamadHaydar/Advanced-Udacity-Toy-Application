...
public class VisualizerActivity extends AppCompatActivity {
    ...
    // TODO (1) Change the name of default setup to setupSharedPreferences Okay
    private void defaultSetup() {
        // TODO (2) Get a reference to the default shared preferences from the PreferenceManager class Okay
        SharedPreferences preferences = PreferenceManager.getDefaultSharedPreferences(this);
        // TODO (3) Get the value of the show_bass checkbox preference and use it to call setShowBass Okay
