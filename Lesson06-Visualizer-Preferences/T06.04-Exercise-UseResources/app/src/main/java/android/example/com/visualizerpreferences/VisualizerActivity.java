...
public class VisualizerActivity extends AppCompatActivity {
    ...
    private void setupSharedPreferences() {
        ...
        // TODO (4) Use resources here instead of the hard coded string and boolean Okay
        mVisualizerView.setShowBass(sharedPreferences.getBoolean(getString(R.string.pref_bass_show_key), getResources().getBoolean(R.bool.pref_bass_show_default_value)));
