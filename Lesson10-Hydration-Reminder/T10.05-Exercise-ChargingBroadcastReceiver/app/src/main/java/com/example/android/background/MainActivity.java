...
public class MainActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // TODO (5) Create and instantiate a new instance variable for your ChargingBroadcastReceiver Okay
        // and an IntentFilter
        intentFilter = new IntentFilter();
        chargingBroadcastReceiver = new ChargingBroadcastReceiver();
        // TODO (6) Call the addAction method on your intent filter and add Intent.ACTION_POWER_CONNECTED Okay
    ...
    // TODO (7) Override onResume and setup your broadcast receiver. Do this by calling Okay
    ...
    // TODO (8) Override onPause and unregister your receiver using the unregisterReceiver method Okay
    ...
    // TODO (1) Create a new method called showCharging which takes a boolean. This method should Okay
    ...
    // TODO (2) Create an inner class called ChargingBroadcastReceiver that extends BroadcastReceiver Okay
    ...
    class ChargingBroadcastReceiver extends BroadcastReceiver {
        ...
        // TODO (3) Override onReceive to get the action from the intent and see if it matches the Okay
        // Intent.ACTION_POWER_CONNECTED. If it matches, it's charging. If it doesn't match, it's not
        // charging.
        // TODO (4) Update the UI using the showCharging method you wrote Okay
    }
}