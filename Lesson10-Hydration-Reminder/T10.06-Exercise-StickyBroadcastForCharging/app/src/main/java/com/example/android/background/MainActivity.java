...
public class MainActivity extends AppCompatActivity implements
    ...
    protected void onResume() {
        ...
        // TODO (1) Check if you are on Android M or later, if so... Okay
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            // TODO (2) Get a BatteryManager instance using getSystemService() Okay
            BatteryManager batteryManager = (BatteryManager) getSystemService(BATTERY_SERVICE);
            // TODO (3) Call isCharging on the battery manager and pass the result on to your show Okay
            // charging method
            boolean isCharging = batteryManager.isCharging();
            showCharging(isCharging);
        } else {

            // TODO (4) If your user is not on M+, then... Okay
            // TODO (5) Create a new intent filter with the action ACTION_BATTERY_CHANGED. This is a Okay
            // sticky broadcast that contains a lot of information about the battery state.
            IntentFilter intentFilter = new IntentFilter(Intent.ACTION_BATTERY_CHANGED);
            // TODO (6) Set a new Intent object equal to what is returned by registerReceiver, passing in null Okay
            ...
            Intent currentBatteryStatusIntent = getBaseContext().registerReceiver(null, intentFilter);
            // TODO (7) Get the integer extra BatteryManager.EXTRA_STATUS. Check if it matches Okay
            ...
            // TODO (8) Update the UI using your showCharging method Okay
            showCharging(isCharging);
