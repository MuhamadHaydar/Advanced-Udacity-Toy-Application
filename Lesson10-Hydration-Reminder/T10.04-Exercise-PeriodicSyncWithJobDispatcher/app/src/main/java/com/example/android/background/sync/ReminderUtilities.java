...
public class ReminderUtilities {
    ...
    //    has been activated or not Okay
    ...
    // TODO (16) Create a synchronized, public static method called scheduleChargingReminder that takes Okay
    ...
    synchronized public static void scheduleChargingReminder(Context context) {
        ...
        // TODO (17) If the job has already been initialized, return Okay
        if (sInitialized) {
            return;
        }
        // TODO (18) Create a new GooglePlayDriver Okay
        GooglePlayDriver driver = new GooglePlayDriver(context);
        // TODO (19) Create a new FirebaseJobDispatcher with the driver Okay
        FirebaseJobDispatcher firebaseJobDispatcher = new FirebaseJobDispatcher(driver);

        Job job = firebaseJobDispatcher.newJobBuilder()
                // We use water reminder service to send the notification and increment the notification
                // value.
                ...
                .build();
        // TODO (20) Use FirebaseJobDispatcher's newJobBuilder method to build a job which: Okay
        ...
        // TODO (21) Use dispatcher's schedule method to schedule the job Okay
        firebaseJobDispatcher.schedule(job);
        // TODO (22) Set sInitialized to true to mark that we're done setting up the job Okay
        sInitialized = true;
    }
}
