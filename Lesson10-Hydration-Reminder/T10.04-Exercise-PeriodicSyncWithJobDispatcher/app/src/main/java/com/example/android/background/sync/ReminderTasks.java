...
public class ReminderTasks {
    ...
    public static final String ACTION_ISSUE_CHARGING_REMINDER = "issue-reminder";
    ...
    // TODO (2) Create an additional task for issuing a charging reminder notification. Okay
