...
public class MainActivity extends AppCompatActivity {
    ...
    // TODO (1) Create a key String called LIFECYCLE_CALLBACKS_TEXT_KEY Okay
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // TODO (6) If savedInstanceState is not null and contains LIFECYCLE_CALLBACKS_TEXT_KEY, set that text on our TextView Okay
        if (savedInstanceState != null) {
            String previousCallbackMethods = savedInstanceState.getString(LIFECYCLE_CALLBACKS_TEXT_KEY);
            mLifecycleDisplay.setText(previousCallbackMethods);
        }
    ...
    // TODO (2) Override onSaveInstanceState Okay
    // Do steps 3 - 5 within onSaveInstanceState
    // TODO (3) Call super.onSaveInstanceState Okay
    // TODO (4) Call logAndAppend with the ON_SAVE_INSTANCE_STATE String Okay
    // TODO (5) Put the text from the TextView in the outState bundle Okay
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        String callbackMethods = (String) mLifecycleDisplay.getText().toString();
        outState.putString(LIFECYCLE_CALLBACKS_TEXT_KEY, callbackMethods);
    }
