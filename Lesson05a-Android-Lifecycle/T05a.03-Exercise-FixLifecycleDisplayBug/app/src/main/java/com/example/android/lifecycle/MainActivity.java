...
public class MainActivity extends AppCompatActivity {
    ...
    // TODO (1) Declare and instantiate a static ArrayList of Strings called mLifecycleCallbacks Okay
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // TODO (4) Iterate backwards through mLifecycleCallbacks, appending each String and a newline to mLifecycleDisplay Okay
        for (String callbackMethod : mLifecycleCallbacks){
            mLifecycleDisplay.append(callbackMethod + "\n");
        }

        // TODO (5) Clear mLifecycleCallbacks after iterating through it Okay
    ...
    protected void onStop() {
        ...
        // TODO (2) Add the ON_STOP String to the front of mLifecycleCallbacks Okay
    ...
    protected void onDestroy() {
        ...
        // TODO (3) Add the ON_DESTROY String to the front of mLifecycleCallbacks Okay
